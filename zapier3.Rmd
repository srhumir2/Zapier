...
In R I found the "dplyr"" and "data.table" packages interesting for their fast and efficient capability of cleaning and summarizing the data. "raster" is a very nice package for working with grid ?data?. For plotting one should not underestimate the base plotting system of R but whenever there is too much coding needed using it, I prefer to use "ggplot2"."caret" is a great package gathering machine learning techniques and whatever preprocessing needed in one place. "Rmarkdown" in combination with LaTex is a great tool for making reports. 
