...
I would like to enter the business sector and found the data analysis really interesting and perfectly fitted to my theoretical background. While teaching math, the biggest challenge is expressing complicated problems in understandable manners and while researching, it is translating real world problems into mathematical statements and vice versa. I am a good independent fast leaner. During the last couple of months I learned SQL and R programming and using it in data analysis. I already am familiar with Python as well and would like to learn it more deeply. 

You can find some works of mine in my [github account](https://github.com/srhumir)
